var toConvert = require('./bikeShare.js');
var fs = require('fs');
function convert (theArray){
  for(var i = 0; i < theArray.features.length; i++){
    ...
    properties.description = whatever[0].trim();
