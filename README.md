...
7. The bottom navigation buttons of the map view, listed from left to right, have the following functionalities:
  1. Find my location
...
9. Once returned to map view, the user can modify map settings by tapping the grey gear in the upper right corner. This shows the filters. From top to bottom:
  ...
  4. Choose radius of shown markers by distance from user. Radius options from left to right are 0.5 mile, 1 mile, 2 miles, or all points available on the map.
...
We would like to thank the following people and organizations for providing the data and support utilized to make this app a reality.
   ...
   * Kelli Borgonia of [Goma Games](http://gomagames.com/) for providing design specs and files.
   * [DevLeague](http://www.devleague.com/) teachers and staff for guidance, support, and advice.
